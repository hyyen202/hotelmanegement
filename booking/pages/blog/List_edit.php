<div class="row" style="padding-top: 3%; border: 1px solid #ccc;  margin:auto">
    <?php
        ...
        ?>
            ...
            <div class="col-md-4">
                <a href=  "index.php?controller=blog&page=edit&id=<?php echo $row['id']?>" style ="text-decoration: none; color:#333333; ">
                    <div class="card" style="width: 100%;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-grid gap-2">
                                <a href="index.php?controller=blog&page=edit&id=<?php echo $row['id']?>" class="btn btn-outline-secondary btn-block">See more</a>
                            </div>
                        </div>
                    </div>
                </a>
